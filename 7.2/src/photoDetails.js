    ...
    return (
        <li>
            <section>
                ...
                <div>
                    Średnia ocena: {averageAndRound(photoToDisplay.ratings)} [liczba głosów:{' '}
                ...
                <Likes
                    ...
                    dislikeIt={disLikeIt}
                />
                <div>Data dodania: {photoToDisplay.date}</div>
                <button
                ...
                <button className="btn btn-success" onClick={() => next(index)}>Następny</button>
                <button className="btn btn-success" onClick={() => previous(index)}>Poprzedni</button>
            </section>
        </li>
    );
